...
export async function getPortfolioAssets(jwt: string) {
    const response = await fetch(`https://rqfdxfod2i.execute-api.ap-southeast-2.amazonaws.com/v1/api/v1/portfolio/assets`, {
        method: "GET",
        headers: {
...
export async function postTrade(jwt: string, trade: Trade) {
    const response = await fetch(`https://rqfdxfod2i.execute-api.ap-southeast-2.amazonaws.com/v1/api/v1/portfolio/trades`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${jwt}`
...
export async function getTrades(jwt: string, pageNo: number = 1, pageSize: number = 10, ticker?: string, sortOrder?: string) {
    ...
    const response = await fetch(`https://rqfdxfod2i.execute-api.ap-southeast-2.amazonaws.com/v1/api/v1/portfolio/trades?${params.toString()}`, {
        method: "GET",
        headers: {
            "Authorization": `Bearer ${jwt}`
        }
...
export async function getPortfolioHistoricalValue(jwt: string) {
    const response = await fetch(`https://rqfdxfod2i.execute-api.ap-southeast-2.amazonaws.com/v1/api/v1/portfolio/value`, {
        method: "GET",
        headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${jwt}`,
...
export async function getMonteCarloForecast(jwt: string) {
    const response = await fetch(`https://rqfdxfod2i.execute-api.ap-southeast-2.amazonaws.com/v1/api/v1/portfolio/forecast`, {
        method: "GET",
        headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${jwt}`,
...
export async function uploadReceipt(receipt_file: File, trade: Trade, jwt: string) {
    ...
    const response = await fetch(`https://rqfdxfod2i.execute-api.ap-southeast-2.amazonaws.com/v1/api/v1/receipt`, {
        method: "POST",
        headers: {
            "Authorization": `Bearer ${jwt}`,
        },
...
export async function getReceiptS3Url(timestamp: number, ticker: string, jwt: string) {
    ...
    const response = await fetch(`https://rqfdxfod2i.execute-api.ap-southeast-2.amazonaws.com/v1/api/v1/receipt?${params}`, {
        method: "GET",
        headers: {
            "Authorization": `Bearer ${jwt}`,
        }
